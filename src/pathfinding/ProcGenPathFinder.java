 ...
 * @author Kevin Glass
 */
public class ProcGenPathFinder implements PathFinder
{
	...
	private ProceduralGenerationMap map;
	 ...
	 */
	public ProcGenPathFinder(ProceduralGenerationMap map, int maxSearchDistance, boolean allowDiagMovement)
	{
	 ...
	 */
	public ProcGenPathFinder(ProceduralGenerationMap map, int maxSearchDistance, boolean allowDiagMovement, AStarHeuristic heuristic)
	{
		...
		while ((maxDepth < maxSearchDistance) && (open.size() != 0))
		{
			...
			for (int x = -1; x < 2; x++)
			{
				for (int y = -1; y < 2; y++)
				{
					...
					// determine the location of the neighbour
					neighbors.add(new Point(x + current.x, y + current.y));
				}
			}
			for (Point neighborPoint : neighbors)
			{
				int xp = neighborPoint.x;
				int yp = neighborPoint.y;
	 ...
	 * @param sy
	 *            The y coordinate of the tile whose cost is being determined
	 * @param tx
	...
	private class Node implements Comparable
	{
		...
		public int compareTo(Object other)
		{
			...
			float of = o.heuristicCost + o.cost;
