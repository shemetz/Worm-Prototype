...
public class AStarPathFinder implements PathFinder
{
	 ...
	 */
	public AStarPathFinder(EnvMap map, int maxSearchDistance, boolean allowDiagMovement)
	{
	 ...
	 */
	public AStarPathFinder(EnvMap map, int maxSearchDistance, boolean allowDiagMovement, AStarHeuristic heuristic)
	{
	...
	public Path findPath(Mover mover, int sx, int sy, int tx, int ty)
	{
		...
		while ((maxDepth < maxSearchDistance) && (open.size() != 0))
		{
			...
			if (map.portals[current.x][current.y] != null)
			{
				neighbors.add(map.portals[current.x][current.y]);
			}
