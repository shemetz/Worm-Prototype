...
public class Elemental_Combat_II_E extends Ability
{
	public Elemental_Combat_II_E(String elementName, int p)
	{
	...
	public void use(Environment env, Person user, Point target)
	{
		...
		for (int i = 0; i < 7; i++)
			if (elementalAttacksPossible[elementNum][i])
				addedAbilities.add(Ability.ability((elementalAttacks[i])+ " <"+getElement()+">", points));
